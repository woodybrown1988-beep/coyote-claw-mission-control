...
test('nav restructure (page-map amendment 2026-07-21): Reports section groups Revenue + Library + Rota Review; old paths 308 to the new home with query preserved', () => {
  ...
  assert.deepEqual(reportsGroup.items.map((i) => i.key), ['revenue', 'report-library', 'rota-review', 'reservations', 'labour', 'costs', 'inventory', 'kitchen-safety'], 'Revenue + Library + Rota Review + Reservations + Labour (centre L1 2026-07-21), in order');
