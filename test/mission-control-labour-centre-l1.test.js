...
test('nav: labour is 2nd in the Reports group (after Revenue, per the 2026-07-22 reorder); Departments no longer holds it', () => {
  ...
  assert.deepEqual(reports.items.map((i) => i.key), ['revenue', 'labour', 'costs', 'reservations', 'operations', 'inventory', 'stock', 'customer-growth', 'kitchen-safety', 'report-library', 'files'], 'Reports order — labour is 2nd');
