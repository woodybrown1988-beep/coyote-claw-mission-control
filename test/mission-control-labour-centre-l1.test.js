...
test('nav move: labour lives in the Reports group AFTER reservations; Departments no longer holds it', () => {
  ...
  assert.deepEqual(reports.items.map((i) => i.key), ['revenue', 'report-library', 'rota-review', 'reservations', 'labour', 'costs', 'inventory'], 'Reports order — labour after reservations');
